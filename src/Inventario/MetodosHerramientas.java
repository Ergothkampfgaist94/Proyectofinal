        ...
        try {
            while (option != 6) {
                ...
                switch (option) {
                    ...
                    case 3:
                        JOptionPane.showMessageDialog(null,
                                ActualizarInfoHerramientas(JOptionPane.showInputDialog("Digite el serial del artículo")));
                        break;
                    case 4:
                        JOptionPane.showMessageDialog(null,
                                BuscarHerramienta(JOptionPane.showInputDialog("Digite el serial del artículo")));
                        break;
                    case 5:
                        JOptionPane.showMessageDialog(null,
                                EliminarHerramienta(JOptionPane.showInputDialog("Digite el serial del artículo")));
                        break;
                    case 6:
